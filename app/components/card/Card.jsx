...
const Card = async ({ data }) => {
    ...
    return (
        ...
        <>
            ...
            <div key={data._id} className="flex flex-col md:flex-row gap-5 p-5 border rounded-md shadow-lg">
                <div className="md:w-1/3 w-full">
                    <img src="/.png" className="w-full h-full object-cover rounded-md" alt="Post" />
                </div>
                <div className="md:w-2/3 w-full flex flex-col justify-between">
                    <div>
